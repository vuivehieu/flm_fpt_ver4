 ...
 * @author ADMIN
 */
@WebServlet(name = "DecisionDeleteController", urlPatterns = {"/decision-delete"})
public class DecisionDeleteController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        new DecisionDAO().softDeleteDecision(request.getParameter("decisionNo"));
