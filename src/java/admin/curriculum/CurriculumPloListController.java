 ...
 * @author PCM
 */
@WebServlet(name = "CurriculumPloListController", urlPatterns = {"/curriculumCheck-plo"})
public class CurriculumPloListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("gui/admin/curriculum/list-plo.jsp").forward(request, response);
    }
