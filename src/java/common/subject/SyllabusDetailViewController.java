 ...
 * @author phanh
 */
@WebServlet(name="SyllabusDetailViewController", urlPatterns={"/syllabusDetails"})
public class SyllabusDetailViewController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("syllabus", dao.getSyllabusBySlbID(slbid));
        } catch (NumberFormatException e) {
            System.out.println("SyllabusDetailController -> get()" + e);
        }
        
        if(subjectCode!= null){
            request.setAttribute("subject", dao.getSubjectBySubjectCode(subjectCode));
