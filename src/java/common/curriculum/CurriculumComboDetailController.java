 ...
 * @author PCM
 */
@WebServlet(name = "CurriculumComboDetailController", urlPatterns = {"/comboDetailView"})
public class CurriculumComboDetailController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("list", curriculumDAO.getAllComboByCurriculumID(curid));

        } catch (NumberFormatException e) {
            System.out.println("common.curriculum -> CurriculumPoDetailController -> doGet(): " + e);
        }

        request.getRequestDispatcher("gui/common/curriculum/combo-detail.jsp").forward(request, response);
    }
