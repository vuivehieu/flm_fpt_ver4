 ...
 * @author PCM
 */
@WebServlet(name = "CurriculumPoDetailController", urlPatterns = {"/poDetailView"})
public class CurriculumPoDetailController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("list", curriculumDAO.getAllPoByCurriculumID(curid));

        } catch (NumberFormatException e) {
            System.out.println("common.curriculum -> CurriculumPoDetailController -> doGet(): " + e);
        }

        request.getRequestDispatcher("gui/common/curriculum/pos-detail.jsp").forward(request, response);
    }
