 ...
 * @author PCM
 */
@WebServlet(name = "CurriculumSubjectDetailController", urlPatterns = {"/subjectDetailView"})
public class CurriculumSubjectDetailController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("list", curriculumDAO.getAllSubjectDtoByCurriculumID(curid));

        } catch (NumberFormatException e) {
            System.out.println("common.curriculum -> CurriculumPoDetailController -> doGet(): " + e);
        }

        request.getRequestDispatcher("gui/common/curriculum/subject-detail.jsp").forward(request, response);
    }
