 ...
 * @author ADMIN
 */
@WebServlet(name="CurriculumAddPloController", urlPatterns={"/curriculum-ploAdd"})
public class CurriculumAddPloController extends HttpServlet{
        /** 
    ...
    throws ServletException, IOException {        
        request.getRequestDispatcher("gui/common/curriculum/plo/add-plo.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        plodao.addConstraint(curid,plodao.insert(name, description, isActive));
