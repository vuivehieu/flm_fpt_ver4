                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach items="${list}" var="item" varStatus="st">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#">
                                                                <span class="list-enq-name">${item.ploName}</span>
                                                            </a>
                                                        </td>
                                                        <td style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; line-height: 3em;">${item.ploDescription}</td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
