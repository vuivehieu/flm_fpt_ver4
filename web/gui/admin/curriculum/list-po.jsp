                                    ...
                                    <div class="card-body table-responsive">
                                        <table id="example" style="text-align: center" class="table">
                                            <tbody>
                                                ...
                                                <c:forEach items="${poList}" var="item" varStatus="st">
                                                    <tr>
                                                        <td>${st.index+1}</td>
                                                        <td>
                                                            <a href="#">
                                                                <span class="list-enq-name">${item.poName}</span>
                                                            </a>
                                                        </td>
                                                        <td style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; line-height: 3em;">${item.poDescription}</td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
