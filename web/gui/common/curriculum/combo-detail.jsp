                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div style="margin-top: 20px">
                                            ...
                                            <a class="btn btn-warning active color-warning-custom" href="comboDetailView?id=${curid}" role="button">Combos</a>
                                        ...
                                        <table class="table table-bordered cart_summary">
                                            <thead>
                                                <tr style="background-color: rgb(185, 182, 182);">
                                                    ...
                                                    <th style="vertical-align: middle;">Combo Name</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#">
                                                                ...
                                                                <small class="cart_ref">${item.comboName_VI}</small>
                                                            </a>
                                                        </td>
                                                        <td>${item.note}</td>
                                                    </tr>                       
