            ...
            <div class="modal-content">
                ...
                <form id="formAdd" class="needs-validation" method="POST" action="">
                    <div class="modal-header" style="background: #4F4F4F;padding: 10px;margin-bottom: 30px">
                        <h5 class="modal-title" id="exampleModalAdd" style="color: white">Add Plo</h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control mt-2" id="inputPloName" placeholder="Input PLO Name" value="" name="inputPloName" aria-describedby="inputGroupPrepend" required style="font-size: 14px;">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
