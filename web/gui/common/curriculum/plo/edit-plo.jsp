            ...
            <div class="modal-content">
                ...
                <form id="formAdd" class="needs-validation" method="POST" action="">
                    <div class="modal-header" style="background: #4F4F4F;padding: 10px;margin-bottom: 30px">
                        <h5 class="modal-title" id="exampleModalAdd" style="color: white">Edit Plo</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="inputCode" class="ml-2" style="font-size: 15px; color:black">PLO Name</label>
                                <div class="input-group">
                                    <input type="text" class="form-control mt-2" id="inputPloName" placeholder="Input PLO Name" value="${plo.ploName}" name="inputPloName" aria-describedby="inputGroupPrepend" required style="font-size: 14px;">
                                    <input type="text" class="form-control mt-2" id="inputPloName" placeholder="Input PLO Name" value="${plo.ploid}" name="inputPloId" aria-describedby="inputGroupPrepend" required style="font-size: 14px;display: none;">
                                    <input type="text" class="form-control mt-2" id="inputPloName" placeholder="Input PLO Name" value="${curid}" name="inputCurid" aria-describedby="inputGroupPrepend" required style="font-size: 14px;display: none;">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <c:forEach var="role" items="${account.roles}">
                                <c:if test="${!stopLoop}">
                                    <c:if test="${(role.rid == 6) || (role.rid == 5)}">
                                        <div class="form-group col-md-6">
                                            <div class="input-group">

                                                <input type="radio" value="1" class="ml-2 mr-2 radio" id="inputStatus1" name="inputStatus" style="font-size: 2px;" aria-describedby="inputGroupPrepend" ${plo.isActive? 'checked="checked"' : ''}>
                                                <label for="inputStatus1" class="" style="font-size: 15px">Active</label>

                                                <input type="radio" value="0" class="ml-2 mr-2 radio" id="inputStatus2" name="inputStatus" style="font-size: 2px;" aria-describedby="inputGroupPrepend" ${!plo.isActive? 'checked="checked"' : ''}>
