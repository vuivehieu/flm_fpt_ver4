                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div style="margin-top: 20px">
                                            ...
                                            <a class="btn btn-warning active color-warning-custom" href="electiveDetailView?id=${curid}" role="button">Electives</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered cart_summary">
                                            <thead>
                                                <tr style="background-color: rgb(185, 182, 182);">
                                                    ...
                                                    <th style="vertical-align: middle;">Elective Name</th>
