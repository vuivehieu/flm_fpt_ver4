                            ...
                            <div class="cor-con-mid">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="display: flex;
                                        ...
                                        <ul>
                                            <li><a href="syllabusDetails?subjectCode=${subjectCode}&slbid=${slbid}" style="color: black;margin-right: 2px;">Overview</a></li>
                                            ...
                                            <li><a href="#" style="color: black;margin-right: 2px;font-weight: bold;">Material</a></li>
                                        ...
                                        <table class="table table-bordered cart_summary">
                                            <thead>
                                                <tr style="background-color: rgb(185, 182, 182);">
                                                    ...
                                                    <th style="vertical-align: middle;">isMain</th>
                                                    <th style="vertical-align: middle;">isHardCopy</th>
                                                    <th style="vertical-align: middle;">isOnline</th>
