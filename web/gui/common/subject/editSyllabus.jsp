                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <textarea type="text" col="2" class="form-control mt-2" rows="10" cols="70" id="inputDescription" placeholder="Input Description" value="${syllabus.description}" name="inputDescription" aria-describedby="inputGroupPrepend" required style="font-size: 15px;height:150px;">${syllabus.description}</textarea>
